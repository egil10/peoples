...
const COUNTRIES = [
  ...
  { code: 'Q784', name: 'Saint Kitts and Nevis' },
  { code: 'Q760', name: 'Saint Lucia' },
  { code: 'Q757', name: 'Saint Vincent and the Grenadines' },
  { code: 'Q730', name: 'Grenada' },
  { code: 'Q785', name: 'Dominica' },
  ...
  { code: 'Q657', name: 'Chad' },
  { code: 'Q1009', name: 'Ivory Coast' },
  { code: 'Q1008', name: 'Burkina Faso' },
  { code: 'Q1007', name: 'Mali' },
